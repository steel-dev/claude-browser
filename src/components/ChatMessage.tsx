      ...
      return (
        <div style={{ 
          ...
          <div style={{ 
            ...
            <img 
              src={TOOL_ICONS[message.name || ''] || 'https://placehold.co/32x32/png?text=🔧'} 
              alt={message.name} 
              style={{ 
                width: '12px', 
                height: '12px',
